...
do
  ...
  echo "  docker pull ${registry}/${contrailImageName}:${tag}" >> ${output_file1}
  echo "  docker tag ${registry}/${contrailImageName}:${tag} 192.168.24.1:8787/${contrailImageName}:${tag}" >> ${output_file1}
  echo "  docker push 192.168.24.1:8787/${contrailImageName}:${tag}" >> ${output_file1}
done
